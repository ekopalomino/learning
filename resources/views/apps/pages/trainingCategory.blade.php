...
Learning Development | Kategori Training
@endsection
		...
		<div class="col-md-12">
			<div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-database"></i>Data Kategori Training
                    </div>
                </div>
                	...
                	<table class="table table-striped table-bordered table-hover" id="sample_2">
                		...
                		<tbody>
                			...
                			<tr>
                				...
                				<td>
                                    <a class="btn btn-xs btn-success modalMd" href="#" value="{{ action('Apps\TrainingManagementController@trainingCategoryEdit',['id'=>$val->id]) }}" title="Edit Data" data-toggle="modal" data-target="#modalMd"><i class="fa fa-edit"></i></a>
                                    {!! Form::open(['method' => 'POST','route' => ['category.destroy', $val->id],'style'=>'display:inline','onsubmit' => 'return ConfirmDelete()']) !!}
