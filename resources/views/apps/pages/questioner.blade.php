...
Learning Development | Data Kuesioner
@endsection
		...
		<div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-database"></i>Data Kuesioner
                    </div>
                </div>
                ...
                @if (count($errors) > 0) 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ route('question.create') }}"><button id="sample_editable_1_new" class="btn red btn-outline sbold"> Record Baru
                            </button></a>
                        </div>
                    </div>
                    @endcan
